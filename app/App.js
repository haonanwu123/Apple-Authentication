...
export default function App() {
  ...
  const login = async () => {
    try{
      const cedential = await AppleAuthentication.signInAsync({
        requestedScopes: [
          AppleAuthentication.AppleAuthenticationScope.FULL_NAME,
          AppleAuthentication.AppleAuthenticationScope.EMAIL,
        ]
      });
      console.log(cedential);
      setUserToken(cedential);
      SecureStore.setItemAsync('apple-credentials', JSON.stringify(cedential));
    } catch (e){
      console.log(e);
    }
  }
    ...
    />
      ...
      return (
        <View>
          ...
          <Button title="Reflesh" onPress={reflesh} />
